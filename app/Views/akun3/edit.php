...
<section class="section">
          ...
          <div class="card">
                  ...
                  <div class="card-body p-4">
                    ...
                    <option value="<?= $value->kode_akun1 ?>" <?= $dtakun3->kode_akun1 ==
$value->kode_akun1
  ? 'selected'
  : null ?>><?= $value->nama_akun1 ?></option>
                    <?php endforeach; ?>
                    </select>
                    </div>
                    <div class="form-group">
                    ...
                    <option value="<?= $value->kode_akun2 ?>" <?= $dtakun3->kode_akun2 ==
$value->kode_akun2
  ? 'selected'
  : null ?>><?= $value->nama_akun2 ?></option>
                    <?php endforeach; ?>
                    </select>
                    </div>
