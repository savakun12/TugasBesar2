<li class="menu-header">Dashboard</li>
              ...
              <li class="#"><a class="nav-link" href="#"><i class="fas fa-share-alt"></i> <span>Posting</span></a></li>
              <li class="#"><a class="nav-link" href="#"><i class="fas fa-balance-scale-right"></i> <span>Neraca Saldo</span></a></li>
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  <li><a class="nav-link" href="<?= site_url(
                    'transaksi'
                  ) ?>">Transaksi Jurnal</a></li>
