...
<section class="section">
  ...
  <thead>
    <tr>
      ...
      <th>Status</th>
      <th>
         <button class="btn btn-primary btn-sm btn-block" id="Barisbaru" onclick="BarisBaru();"><i class="fa fa-plus"></i> Add Baris </button>
      </th>
    </tr>
  </thead>
  <tbody>
         <!-- disini form dinamis tombol baris memakai jQuerry -->
  </tbody>
</table>
